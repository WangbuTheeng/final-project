                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach($departments as $department)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{ $department->faculty->name }}</div>
                                    <div class="text-sm text-gray-500">{{ $department->faculty->code }}</div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">
                                        <span class="capitalize">{{ $department->degree_type }}</span> Degree
                                    </div>
                                    <div class="text-sm text-gray-500">
                                        {{ $department->duration_years }} years
                                    </div>
                                </td>
