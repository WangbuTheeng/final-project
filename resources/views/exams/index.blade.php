            ...
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-1">Manage and monitor all examinations</p>
                    </div>
                ...
                <form method="GET" action="{{ route('exams.index') }}" class="grid grid-cols-1 md:grid-cols-6 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="search" id="search" value="{{ request('search') }}"
                               placeholder="Exam title or course"
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">{{ $stats['ongoing'] ?? 0 }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div>
                                            ...
                                            @if($exam->venue)
                                                <div class="text-sm text-gray-500">{{ $exam->venue }}</div>
                                            @endif
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">{{ $exam->classSection->course->title }}</div>
                                        <div class="text-sm text-gray-500">{{ $exam->classSection->course->code }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        ...
                                        <div class="text-gray-500">{{ $exam->exam_date->format('H:i') }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        {{ $exam->total_marks }}
                                        <div class="text-xs text-gray-500">Pass: {{ $exam->pass_mark }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <div class="flex space-x-2">
                                            ...
                                            @if($exam->status === 'completed')
                                                <a href="{{ route('grades.exam-results', $exam) }}" 
                                                   class="text-green-600 hover:text-green-900">Results</a>
                                            @elseif(in_array($exam->status, ['ongoing', 'completed']))
                                                <a href="{{ route('grades.create-for-exam', $exam) }}" 
                                                   class="text-purple-600 hover:text-purple-900">Grades</a>
                                            @endif
                                        </div>
                                    </td>
                                </tr>
