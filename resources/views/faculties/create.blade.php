...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Create Faculty</h1>
            <p class="mt-1 text-sm text-gray-500">Add a new faculty to the institution</p>
        </div>
    ...
    <div class="bg-white shadow-sm rounded-lg border border-gray-200">
        ...
        <form action="{{ route('faculties.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <select name="dean_id" 
                    ...
                    @foreach($potentialDeans as $user)
                        <option value="{{ $user->id }}" {{ old('dean_id') == $user->id ? 'selected' : '' }}>
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">Uncheck to create an inactive faculty</p>
            </div>
