...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Edit Grading System</h1>
            <p class="mt-1 text-sm text-gray-500">Update grading system details and grade scales</p>
        </div>
    ...
    <div class="bg-white shadow-sm rounded-lg border border-gray-200">
        <div class="px-6 py-4 border-b border-gray-200">
            ...
            <p class="mt-1 text-sm text-gray-500">Update the grading system details and define grade scales</p>
        </div>

        <form method="POST" action="{{ route('grading-systems.update', $gradingSystem) }}" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div>
                    ...
                    <input type="text" 
                           name="name" 
                           id="name" 
                           value="{{ old('name', $gradingSystem->name) }}"
                ...
                <div>
                    ...
                    <input type="text" 
                           name="code" 
                           id="code" 
                           value="{{ old('code', $gradingSystem->code) }}"
                ...
                <div>
                    ...
                    <input type="number" 
                           name="order_sequence" 
                           id="order_sequence" 
                           value="{{ old('order_sequence', $gradingSystem->order_sequence) }}"
                           min="1"
                ...
                <div class="flex items-center">
                    <input type="checkbox"
                           ...
                           id="is_default"
                           value="1"
                           {{ old('is_default', $gradingSystem->is_default) ? 'checked' : '' }}
            ...
            <div class="mb-8">
                ...
                <textarea name="description" 
                          ...
                          placeholder="Describe this grading system...">{{ old('description', $gradingSystem->description) }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-8">
                ...
                <div id="grade-scales-container">
                    <!-- Existing grade scales will be loaded here -->
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const existingGradeScales = @json($gradingSystem->gradeScales);
    existingGradeScales.forEach(gradeScale => {
        addGradeScale(gradeScale);
    });

    // If no existing grade scales, add one empty one
    ...
    function addGradeScale(gradeScale = null) {
                ...
                <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                    <div>
                        ...
                        <input type="text" 
                               ...
                               placeholder="A+"
                               value="${gradeScale ? gradeScale.grade_letter : ''}"
                               required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" 
                               ...
                               placeholder="80"
                               value="${gradeScale ? gradeScale.min_percent : ''}"
                               required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" 
                               ...
                               min="0" max="100" step="0.01"
                               placeholder="100"
                               value="${gradeScale ? gradeScale.max_percent : ''}"
                               required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" 
                               ...
                               placeholder="4.0"
                               value="${gradeScale ? gradeScale.grade_point : ''}"
                               required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               value="${gradeScale ? gradeScale.description || '' : ''}">
                    </div>
                </div>
            </div>
        `;
