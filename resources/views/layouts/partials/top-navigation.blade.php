...
<div class="sticky top-0 z-30 flex h-16 bg-white/95 backdrop-blur-xl shadow-soft-lg border-b border-gray-200/50">
    ...
    <button
        type="button"
        class="px-3 sm:px-4 text-gray-500 hover:text-brand hover:bg-brand/5 transition-all duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-brand/20 lg:hidden rounded-lg mx-1 sm:mx-2 my-2"
